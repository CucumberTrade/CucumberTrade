...
const config: Config = {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {
          href: 'https://github.com/CucumberTrade/CucumberTrade',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Website',
              href: 'https://cucumber.trade/',
            },
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()}. All Rights Reserved by Cucumber Trade.`,
    },
    prism: {
